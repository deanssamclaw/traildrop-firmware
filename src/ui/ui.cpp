...
// --- Display driver ---
// Local TFT instance shares the SPI bus already initialized by hal::display_init()
static TFT_eSPI lvgl_tft;
static TFT_eSPI* tft_ptr = &lvgl_tft;
...
static const uint8_t* s_lxmf_dest = nullptr;
...
void ui_set_send_context(const crypto::Identity* id, const uint8_t* our_lxmf_dest) {
    s_identity = id;
    s_lxmf_dest = our_lxmf_dest;
}

const crypto::Identity* ui_get_identity() { return s_identity; }
const uint8_t* ui_get_lxmf_dest() { return s_lxmf_dest; }
